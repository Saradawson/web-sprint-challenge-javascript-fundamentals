...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Answer: Nested function can access internal because they are both located inside myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    const newNames = []
    array.forEach(array => {
      newNames.push(`name: ${array.animal_name}, scientific: ${array.scientific_name}`);
    })
    return newNames;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const newNames = array.map(array => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const animalsLowPop = array.filter(array => {
      return array.population < 5;
    });
    return animalsLowPop;
  }
  ...
  */
  ...
  function USApop(array){
    const pop = array.reduce((acc, array) => {
